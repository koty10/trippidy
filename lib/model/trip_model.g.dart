...
void _tripModelAttach(IsarCollection<dynamic> col, Id id, TripModel object) {
  object.id = id;
  object.members
      .attach(col, col.isar.collection<MemberModel>(), r'members', id);
}
...
extension TripModelQueryFilter
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> nameEqualTo(
    String value, {
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> nameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'name',
        value: '',
...
extension TripModelQueryLinks
    on QueryBuilder<TripModel, TripModel, QFilterCondition> {
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> members(
  ...
  QueryBuilder<TripModel, TripModel, QAfterFilterCondition> membersIsEmpty() {
    return QueryBuilder.apply(this, (query) {
...
extension TripModelQuerySortBy on QueryBuilder<TripModel, TripModel, QSortBy> {
  QueryBuilder<TripModel, TripModel, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<TripModel, TripModel, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TripModelQuerySortThenBy
  ...
  QueryBuilder<TripModel, TripModel, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<TripModel, TripModel, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension TripModelQueryWhereDistinct
  ...
  QueryBuilder<TripModel, TripModel, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TripModelQueryProperty
  ...
  QueryBuilder<TripModel, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
