...
const CategoryModelSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'itemBaseCollection': LinkSchema(
      id: 6018944648338432927,
      name: r'itemBaseCollection',
...
List<IsarLinkBase<dynamic>> _categoryModelGetLinks(CategoryModel object) {
  return [object.itemBaseCollection];
}

void _categoryModelAttach(
    IsarCollection<dynamic> col, Id id, CategoryModel object) {
  object.id = id;
  object.itemBaseCollection.attach(
      col, col.isar.collection<ItemBaseModel>(), r'itemBaseCollection', id);
}
...
extension CategoryModelQueryLinks
    on QueryBuilder<CategoryModel, CategoryModel, QFilterCondition> {
  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      itemBaseCollection(FilterQuery<ItemBaseModel> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'itemBaseCollection');
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      itemBaseCollectionLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'itemBaseCollection', length, true, length, true);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      itemBaseCollectionIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'itemBaseCollection', 0, true, 0, true);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      itemBaseCollectionIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'itemBaseCollection', 0, false, 999999, true);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      itemBaseCollectionLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'itemBaseCollection', 0, true, length, include);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      itemBaseCollectionLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'itemBaseCollection', length, include, 999999, true);
    });
  }

  QueryBuilder<CategoryModel, CategoryModel, QAfterFilterCondition>
      itemBaseCollectionLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'itemBaseCollection', lower, includeLower, upper, includeUpper);
    });
  }
}
